...
def run():
  sdl2.ext.init()
  window = sdl2.ext.Window("Pong Game using SDL2", size=win_dim)
  window.show()
  ...
  world.add_system(aicontroller)#Adds applicator
  world.add_system(movement)
  world.add_system(collision)
  world.add_system(spriterenderer)
  factory = sdl2.ext.SpriteFactory(sdl2.ext.SOFTWARE)
  sp_paddle1 = factory.from_color(WHITE, size=(20, 100)) # Basically makes a white rectangle
  sp_paddle2 = factory.from_color(WHITE, size=(20, 100))
  sp_ball = factory.from_color(WHITE, size=(20, 20))# Creates a white circle
